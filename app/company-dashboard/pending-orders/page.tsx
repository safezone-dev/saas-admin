          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Actividades asignadas pendientes por responder
              </p>
                ...
                (order: any) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center">
                      ...
                      <a
                        href={`/company-dashboard/forms/${order.id}`}
                        className="inline-flex rounded-xl bg-blue-600 px-3 py-2 text-xs font-semibold text-white"
                      >
                        Responder
                      </a>
